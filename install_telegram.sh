...
update_progress 40 "Installing Requirements."
...
SERVICE_FILE=/etc/systemd/system/telegram-bot-en.service
...
ExecStart=$SHARED_VENV/bin/python $SCRIPT_DIR/telegram/robot.py
Restart=always
User=$(whoami)
...
sudo systemctl enable telegram-bot-en.service

update_progress 100 "Starting Telegram bot service."
sudo systemctl start telegram-bot-en.service

update_progress 100 "Telegram bot service installed & started successfully."
